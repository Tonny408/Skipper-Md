...
skipper({ nomCom: "crew", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
skipper({ nomCom: "join", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
skipper({ nomCom: "jid", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
skipper({ nomCom: "block", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
skipper({ nomCom: "unblock", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
skipper({ nomCom: "kickall", categorie: 'Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
skipper({ nomCom: "save", categorie: "Mods" }, async (dest, zk, commandeOptions) => {

...
skipper({ nomCom: "owner", categorie: "General", reaction: "💞" }, async (dest, zk, commandeOptions) => {
...
skipper({ nomCom: "dev", categorie: "General", reaction: "💞" }, async (dest, zk, commandeOptions) => {
    const { ms, mybotpic } = commandeOptions;
...
skipper({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {

...
let evt = require(__dirname + "/framework/skipper");
const {isUserBanned , addUserToBanList , removeUserFromBanList} = require("./bdd/banUser");
const  {addGroupToBanList,isGroupBanned,removeGroupFromBanList} = require("./bdd/banGroup");
const {isGroupOnlyAdmin,addGroupToOnlyAdminList,removeGroupFromOnlyAdminList} = require("./bdd/onlyAdmin");
//const //{loadCmd}=require("/framework/mesfonctions")
let { reagir } = require(__dirname + "/framework/app");
var session = conf.session.replace(/SKIPPER-MD-WA-BOT;;;=>/g,"");
      ...
      await zk.sendMessage(origineMessage, { delete: key });
        ...
        console.log('.... ' + er);
            ...
            if (verifCom) {
                ...
                const cd = evt.cm.find((skipper) => skipper.nomCom === (com));
                if (cd) {
                    try {
...
📌Powred by *Tonny 408®🐐*`;
            ...
            let msg = `Goodbye to that motherfucker, Powered by *SKIPPER-MD*;\n`;
...
║❒ _Join *SKIPPER-MD* Channel for Updates_
https://chat.whatsapp.com/IMqAwWV0ulOA1yRuXfmBO2

║❒ *JOIN OUR WhatsApp Gʀᴏᴜᴘ*
https://chat.whatsapp.com/IMqAwWV0ulOA1yRuXfmBO2

║❒ *FOLLOW THE DEVELOPER* 🪄 
https://instagram.com/homabayian 

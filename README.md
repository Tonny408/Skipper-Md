...
**📌DEPLOY ON HEROKU**
   ...
   - ***`Get Session` by [`SCANING QR`](https://skipper-md-qr-9aafe93739d9.herokuapp.com) Or [`PAIRING CODE`](https://skipper-md-pair-code-4ea42498ed92.herokuapp.com/pair) Then `Go-to Whatapp>Three dots>Linked Devices`***

...
**📌DEPLOY ON HEROKU**
   ...
   - ***`Get Session` by [`SCANING QR`](https://skipper-md-qr-9aafe93739d9.herokuapp.com) Or [`PAIRING CODE`](https://replit.com/@franceking1/Flash-Md-Pairing-1?v=1) Then `Go-to Whatapp>Three dots>Linked Devices`***

...
**📌DEPLOY ON HEROKU**
   ...
   - ***`Get Session` by [`SCANING QR`](https://legacy-md-qr.onrender.com) Or [`PAIRING CODE`](https://replit.com/@franceking1/Flash-Md-Pairing-1?v=1) Then `Go-to Whatapp>Three dots>Linked Devices`***
